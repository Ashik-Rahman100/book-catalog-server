...
router.post('/login', (0, validateRequest_1.default)(auth_validation_1.AuthValidation.createUserZodSchema), auth_controller_1.AuthController.loginUser);
...
router.patch('/add-to-wish/:id', auth_controller_1.AuthController.addToWishList);
router.get('/wishList/:id', auth_controller_1.AuthController.getWishList);
router.patch('/remove-wish/:id', auth_controller_1.AuthController.removeWishList);
